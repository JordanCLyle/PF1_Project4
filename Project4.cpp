...
{
   cout << "\n------------------------------------------------------------\n";
   cout << "\nAs you look ahead, you stumble upon a bridge\n";
   cout << "You realize that if you go forwards you cannot cross back to the other side of the dungeon.\n";
   cout << "Will you continue to the next part, or keep exploring?.\n";
...
{
   cout << "\n------------------------------------------------------------\n";
   cout << "\nA clearing in the cave has opened up and given a view of a large patch of grassland.\n";
   cout << "After observing the area, you notice a bunny as the only indicator of life.\n";
   cout << "The room is likely a trap, but what harm can a bunny do?.\n";
...
{
   cout << "\n------------------------------------------------------------\n";
   cout << "\nYou are almost to the exit, however your path is blocked.\n";
   cout << "The exit requires a key.\n";
   cout << "Maybe the monsters that are starting to swarm you will have it?.\n";

   // ADD CODE HERE
   health = health - FightBattle(DWARF) - FightBattle(TROLL) - FightBattle(BUNNY);
...
{
   cout << "\n------------------------------------------------------------\n";
   cout << "\nA secret room has been discovered.\n";
   cout << "In this room, riches have been stored with the expectation no one would find it.\n";
   cout << "However, now that you have found it, all of the riches belong to you.\n";

   // ADD CODE HERE
   gold = gold + 1000;
   PrintStatus(gold, health);
   char direction = GetDirection();
   while (direction == 'W' || direction == 'E' || direction == 'S')
   {
       direction = GetDirection();
   }
   if (direction == 'N')
